 ...
 * 
 */
public class FastLinkedList<E> extends AbstractSequentialList<E> implements List<E>, Deque<E>, IFastLinkedList<E>, Cloneable, java.io.Serializable {
	...
	void linkBefore(E e, Node<E> succ) {
		// 如果节点不在列表中，
		if (succ.prev == null && succ.next == null) {
			return;
		}
		// assert succ != null;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.handee.utils.IFastLinkedList#firt()
	 */
	@Override
	public Node<E> first() {
		final Node<E> f = first;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.handee.utils.IFastLinkedList#last()
	 */
	@Override
	public Node<E> last() {
		final Node<E> l = last;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.handee.utils.IFastLinkedList#getNode(int)
	 */
	 ...
	 * 
	 * @see
	 * com.handee.utils.IFastLinkedList#set(com.handee.utils.FastLinkedList.
	 ...
	 * 
	 * @see
	 * com.handee.utils.IFastLinkedList#add(com.handee.utils.FastLinkedList.
	 * Node, java.lang.Object)
	 */
	 ...
	 * 
	 * @see
	 * com.handee.utils.IFastLinkedList#remove(com.handee.utils.FastLinkedList
	 * .Node)
	 */
	 ...
	 * 
	 * @see
	 * com.handee.utils.IFastLinkedList#get(com.handee.utils.FastLinkedList.
	 * Node, int)
	 */
	public FastLinkedList.Node<E> get(FastLinkedList.Node<E> begin, int offset) {
		if (offset <= 0) {
			return begin;
		}
		Node<E> node = begin;
	 ...
	 * 
	 * @see
	 * com.handee.utils.IFastLinkedList#next(com.handee.utils.FastLinkedList
	 * .Node)
	 */
	public FastLinkedList.Node<E> next(FastLinkedList.Node<E> node) {
		if (node == last) {
			return null;
		}
		return node.next;
	...
	public Object clone() throws CloneNotSupportedException{
		FastLinkedList<E> clone = superClone();
