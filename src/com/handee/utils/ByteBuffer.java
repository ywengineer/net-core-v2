...
public final class ByteBuffer implements Cloneable, Serializable {
    ...
    public void writeString(String s, String charSet) {
        try {
            ...
            // e.printStackTrace();
            logger.error("ByteBuffer.writeString Error :: ", e);
        }
    }
    ...
    public String readString(String charSet) {
        try {
            ...
            e.printStackTrace();
            logger.error("ByteBuff.readString Error :: ", e);
        }
        return "";
    ...
    private void writeNumber(long value, int bytes) {
        if (bigEndian) {
            int j = 0;
            for (int i = bytes - 1; i >= 0; i--, j++) {
                numData[j] = (byte) (value >> i * 8);
            }
        } else {
    ...
    public static void main(String[] args) {
        ...
        // bb.writeFloat(2.4f);
        // bb.writeString("中国人Abc./", charset);
        // System.out.println(StringUtils.join(ArrayUtils.toObject(bb.getBytes())));
        // System.out.println(bb.readFloat());
        // System.out.println(bb.readString(charset));
    }
}