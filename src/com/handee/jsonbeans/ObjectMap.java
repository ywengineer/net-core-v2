...
public class ObjectMap<K, V> {
	 ...
	 * time this method is called. Use the {@link com.handee.jsonbeans.ObjectMap.Entries} constructor for nested or multithreaded iteration. */
	 ...
	 * this method is called. Use the {@link com.handee.jsonbeans.ObjectMap.Entries} constructor for nested or multithreaded iteration. */
	public Keys<K> keys () {
		if (keys == null)
			keys = new Keys(this);
		else
