...
import com.handee.jsonbeans.ObjectMap.Entry;
import com.handee.jsonbeans.ObjectMap.Values;
 ...
 * https://code.google.com/p/jsonbeans/
 *
 * @author Nathan Sweet
 */
public class Json {
    ...
    public void writeFields(Object object) {
        ...
        if (fields == null) fields = cacheFields(type);
        int i = 0;
        for (FieldMetadata metadata : new Values<>(fields)) {
