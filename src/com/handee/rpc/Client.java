...
import com.handee.rpc.FrameworkMessage.DiscoverHost;
import com.handee.rpc.FrameworkMessage.RegisterTCP;
import com.handee.rpc.FrameworkMessage.RegisterUDP;
...
/**
 * Represents a TCP and optionally a UDP connection to a {@link com.handee.rpc.Server}.
 *
...
public class Client extends Connection implements EndPoint {
    ...
    /**
     * Calls {@link #connect(int, java.net.InetAddress, int) connect} with the values last passed to connect.
     *
    ...
    /**
     * Calls {@link #connect(int, java.net.InetAddress, int) connect} with the specified timeout and the other values last passed to
     * connect.
     *
     * @throws IllegalStateException if connect has never been called.
     */
