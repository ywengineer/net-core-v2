...
import com.handee.rpc.FrameworkMessage.Ping;
...
/**
 * Represents a TCP and optionally a UDP connection between a {@link com.handee.rpc.Client} and
 * a {@link com.handee.rpc.Server}. If either underlying connection is closed or errors, both
...
public class Connection {
     ...
     * time}. When the connection receives a {@link com.handee.rpc.FrameworkMessage.Ping}
     * object with {@link com.handee.rpc.FrameworkMessage.Ping#isReply isReply} set to true, the new return trip
     * time is available.
     */
     ...
     * {@link com.handee.rpc.FrameworkMessage.Ping} response has not yet been received.
     */
    ...
    /**
     * Returns the local {@link com.handee.rpc.Client} or {@link com.handee.rpc.Server} to which this
     * connection belongs.
     */
     ...
     * specified threshold, {@link com.handee.rpc.Listener#idle(com.handee.rpc.Connection)} will be called for
